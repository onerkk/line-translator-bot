...
COMMANDS = [
    ...
    entry("ack", "確認", "ack", "建立雙語作業確認。按「了解」記錄已理解；「查看回覆」查名單。", "Buat konfirmasi bilingual. Paham mencatat pemahaman; Status menampilkan jawaban.", "/確認 今天下班前請完成設備檢查。", aliases=("确认",), scope="group", usage="通知內容"),
