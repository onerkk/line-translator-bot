...
本頁記錄全員確認完成卡的功能與前版驗證。本次累積更新另包含翻譯語意修正，目前版本與驗證請見 `UPDATE_TRANSLATION_ROOT_FIX_20260910.md`。
...
前版先將啟動檢查配對到附件實際提供的模組版本，保留嚴格的 API／build 檢查。此次累積更新已實作抽象指稱與數量所指對象的判斷，並將模組和啟動檢查同步更新為 `2026-09-10.10-referent-bound-quantities`。
